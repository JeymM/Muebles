...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-10-2021 a las 19:43:33
...
(25, 5, 1500000, 'mueble para sala,mueble para sala', 'sofa', 1),
(74, 12, 150000, 'categoria alcoba,categoria alcoba', 'silla escritorio', 1);
...
INSERT INTO `compra` (`id_compra`, `id_cliente_fk`, `id_art_fk`, `valor_total`, `fecha_pago`, `cantidad`) VALUES
(1, 45, 1, 10500, '0000-00-00 00:00:00', 2);
...
--
ALTER TABLE `compra`
  ADD CONSTRAINT `compra_ibfk_1` FOREIGN KEY (`id_cliente_fk`) REFERENCES `cliente` (`id`),
  ADD CONSTRAINT `compra_ibfk_2` FOREIGN KEY (`id_art_fk`) REFERENCES `articulo` (`id`);
