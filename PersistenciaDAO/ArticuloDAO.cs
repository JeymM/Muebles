...
namespace Muebles
{
    public class ArticuloDAO
    {
        ...
        public ArticuloDAO(string ide,string id_provee,string prec,string descrip,string nombre)
        {
        ...
        {
            return "Insert into articulo(id,nit_fk,precio,descripcion,nombre) values(" + ide + ",'" + id_provee + "', '" + prec + "','" + descrip + "','" + nombre + "');";
        }
        public string Actualizacion()
        {
            return "update articulo set " + "nit_fk='" + id_provee + "'," + "precio = '" + prec + "', " + "descripcion='" + descrip + "', " + "nombre='" + nombre + "' where id=" + ide + "";
        }
